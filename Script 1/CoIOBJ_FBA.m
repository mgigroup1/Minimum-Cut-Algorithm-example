...
%     end
 ...
 %% change the CoI by case
    if k < 22
    % use your original <80 values
    f=[zeros(4984,1); ...
       0.89; ...   % ipa (4985)
       0; ...
       0.01; ...   % acetate (4987)
...
subplot(3,2,6)
hold on 
plot(concentration(1:5,1),concentration(1:5,8)*0.08710,'*') % 0.08811
xs=linspace(0,0.1*(k),k);
